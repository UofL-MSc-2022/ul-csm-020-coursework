...
// createdAt and updatedAt times automatically.  However, updates are not
// applicable to Like objects.  The only valid change to a like is deletion.
// Therefore, specify that only the createdAt time should be maintained.
